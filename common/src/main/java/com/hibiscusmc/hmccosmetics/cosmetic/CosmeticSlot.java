...
public class CosmeticSlot {
    ...
    public static final CosmeticSlot NONE = register("NONE");
    public static final CosmeticSlot SKIN = register("SKIN");
    public static final CosmeticSlot PARTICLE = register("PARTICLE");
