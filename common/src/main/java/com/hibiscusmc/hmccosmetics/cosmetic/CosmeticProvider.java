...
public abstract class CosmeticProvider {
    protected static final Map<CosmeticSlot, BiFunction<String, ConfigurationNode, Cosmetic>> MAPPINGS = Map.ofEntries(
            ...
            Map.entry(CosmeticSlot.NONE, CosmeticNoneType::new),

            Map.entry(CosmeticSlot.SKIN, CosmeticSkinType::new),

            Map.entry(CosmeticSlot.PARTICLE, CosmeticParticleType::new)
    );
